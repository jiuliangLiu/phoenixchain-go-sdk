...
import (
	...
	"github.com/jiuliangLiu/phoenixchain-go-sdk/accounts"
...
func (w *Wallet) SelfDerive(base []accounts.DerivationPath, chain platon.ChainStateReader) {
...
func (w *Wallet) Account(address common.Address) (accounts.Account, error) {
	...
	return accounts.Account{}, fmt.Errorf("no account found")
}
